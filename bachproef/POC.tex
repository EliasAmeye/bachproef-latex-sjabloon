...
Na het opzetten van onze Vagrantfile zullen we 'vagrant up' uitvoeren in een command line. Dit kan in Windows Powershell, maar ook in een Linux terminal of een andere soort terminal.
