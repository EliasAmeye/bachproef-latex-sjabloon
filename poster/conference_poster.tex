...
\color{black}
In kader van dit onderzoek werd er ter ondersteuning een proof of concept opgezet. Deze proof of concept had als doel om te bewijzen dat de verkozen PostgreSQL High Availability cluster oplossing: Patroni voldeed aan de beschreven requirements uit het onderzoek.
