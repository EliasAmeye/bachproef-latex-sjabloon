...
\PaperTitle{High Availability oplossingen voor PostgreSQL: een vergelijkende studie en proof of concept}
...
\CoPromotor{Ruben Demey\textsuperscript{2} (iDirect)}
\affiliation{\textbf{Contact:}
  \textsuperscript{1} \href{mailto:elias.ameye@student.hogent.be}{elias.ameye@student.hogent.be};
  \textsuperscript{2} \href{mailto:rdem@idirect.net}{rdem@idirect.net};
}
